// miniproject.cpp : Defines the entry point for the console application.
//
#include "stdafx.h"
...
void title()
{
    ...
    drawstring(150.0,450.0,"COMPUTER GRAPHICS MINI PROJECT",1);
    drawstring(160.0,350.0," ROHAN MAHAVEER     4AL17CS077 ",3);
    drawstring(160.0,300.0," RAKSHA S                    4AL17CS073",3);
drawstring(160.0,250.0," COMPUTER GRAPHICS LABORATORY",3);

    drawstring(60.0,100.0,"ALVAS INSTITUTE OF ENGINEERING AND TECHNOLOGY",3);
